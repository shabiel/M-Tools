JLISETUP	;JLI-SETUP DUPLICATE SET OF REDONE ROUTINES ;07/23/10  14:02
	;;0.0;
	Q
	;
START	;
	...
	I CURRNAME=NEWNAME W !,"CAN'T HAVE THE SAME NAMESPACE FOR BOTH" Q
...
SET1(CURRNAME,NEWNAME,INPUT,OUT)	;
	...
	D REPLACE(CURRNAME,NEWNAME,GLOBAL)
	D SAVE1(OUT,GLOBAL)
	Q
	;
CREATE(ROUNAME)	;

XTMREDO	;JLI/FO-OAK-ROUTINE TO MAKE ROUTINES EASIER TO READ ;08/07/11  21:58
...
ENTRY1(RTN)	;
	...
	. . Q
	. I @OUTGLOB@(OUTCNT,0)'=" QUIT" S OUTCNT=OUTCNT+1,@OUTGLOB@(OUTCNT,0)=" QUIT"
	. Q
...
EE	; falls through from above or by direct call
	D:XTMLOG DEBUG^XTMLOG("ENTERED EE","IFFLAG,LIN,OUTLIN")
	I LIN="",OUTLIN'="",OUTLIN'=" " S OUTLIN=$$OUTPUT(OUTLIN,DODOTTOT+DOFORTOT,DDOT),IFFLAG=0,OLDIFFLG=0,OUTLIN=""
	I LIN="",FORFLAG S OUTLIN=$$OUTPUT(" QUIT 0",DODOTTOT+DOFORTOT,DDOT),FORFLAG=0
	I LIN="" Q
	S CONIFSTR=""
	...
	S ARG2=""
	I ARG[":",CM'="LOCK",'IFFLAG D:XTMLOG DEBUG^XTMLOG("ARG=","ARG,LIN") S CONIFSTR=$$CONDIF($P(ARG,":",2,99))
	;I ARG[":",CM'="LOCK",IFFLAG D:XTMLOG DEBUG^XTMLOG("ARG2=","ARG,LIN") S ARG2=$P($$CONDIF($P(ARG,":",2)),"IF ",2)
	S COM=CM I ARG[":",IFFLAG S COM=COM_":"_$P(ARG,":",2,99)
	D:XTMLOG DEBUG^XTMLOG("BEFORE D SEP","COM,ARG,IFFLAG")
	D SEP
	D:XTMLOG DEBUG^XTMLOG("AFTER D SEP","ARG,COM")
	S POSTCOND=""
	I COM[":",ARG=":"_$P(ARG,":",2,99)
...
CONDIF2(ARG,COM,LIN)	;
	N VALUE
	I ARG["$" F I=1:1 S CH=$E(ARG,I) Q:CH=""  D QUOTE:CH=QUOTECHR I CH="$" D FUN
	D:XTMLOG DEBUG^XTMLOG("CONDIF2","ARG")
	...
	I $E(SAV,IP,999)'="" S LIN=COM_" "_$E(SAV,IP,999)_" "_LIN
	D:XTMLOG DEBUG^XTMLOG("CONDIF2","VALUE,ARG,LIN")
	Q VALUE
FUN	;
...
OUTPUT(OUTLIN,TOT,DDOT)	; output a line
	...
	IF FORFLAG S FORCNT=$G(@FORGLOB@(TOT,0))+1,^(0)=FORCNT,^(FORCNT,0)=OUTLIN Q " "
...
DGX	; DO, GO, eXecute
	...
	;
	D:XTMLOG DEBUG^XTMLOG("DGX1","CONIFSTR,ARG,OUTLIN")
...
DDOT	;
	...
	I CONIFSTR="" S OUTLIN=OUTLIN_"DO DODOT"_DODOTTO1 I IFFLAG,COM[":" S OUTLIN=OUTLIN_":"_$P(COM,":",2,99)
	I IFFLAG S OUTLIN=OUTLIN_" "
	I 'IFFLAG S OUTLIN=$$OUTPUT(OUTLIN,DODOTTOT+DOFORTOT,$G(DDOT))
	N OUTLIN S OUTLIN=" "
	N DODOTTOT,DOFORTOT
	S DODOTTOT=DODOTTO1,DOFORTOT=0
	N IFFLAG,FORFLAG S IFFLAG=0,FORFLAG=0
	S @DOTGLOB@(DODOTTOT,1,0)=" ;"
	S @DOTGLOB@(DODOTTOT,2,0)="DODOT"_DODOTTOT_" ;"
	...
	. Q
	S DODOTCNT=@OUTGLOB@(DODOTTOT,0) I @OUTGLOB@(DODOTTOT,DODOTCNT,0)'=" QUIT" S OUTLIN=$$OUTPUT(" QUIT",DODOTTOT+DOFORTOT,DDOT)
...
SEPQ	;
	...
	I CH="" G ERR
	G SEPQ:CH'=QUOTECHR S I=I+1,CH=$E(LIN,I) G:CH=QUOTECHR SEPQ Q
	;
LEN	;
